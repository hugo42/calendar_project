...
Entre la Société Acme, 10 rue Gustave Delory, 42 000 Saint Etienne, au Capital Social de 54 400 000€, immatriculée au Registre du Commerce et des Sociétés de Saint Etienne sous le numéro 89743098, SIRET 9873403984, représentée par M. Jean DUPONT, en qualité de gérant, dûment habilité aux fins des présentes. La société peut être jointe par email en cliquant sur le formulaire de contact accessible via la page d’accueil du site.
...
Les prix des produits vendus au travers des sites Internet sont indiqués en Euros hors taxes et précisément déterminés sur les pages de descriptifs des Produits. Ils sont également indiqués en euros toutes taxes comprises (TVA + autres taxes éventuelles) sur la page de commande des produits, et hors frais spécifiques d'expédition. Pour tous les produits expédiés hors Union européenne et/ou DOM-TOM, le prix est calculé hors taxes automatiquement sur la facture. Des droits de douane ou autres taxes locales ou droits d'importation ou taxes d'état sont susceptibles d'être exigibles dans certains cas. Ces droits et sommes ne relèvent pas du ressort du Vendeur. Ils seront à la charge de l'acheteur et relèvent de sa responsabilité (déclarations, paiement aux autorités compétentes, etc.). Le Vendeur invite à ce titre l'acheteur à se renseigner sur ces aspects auprès des autorités locales correspondantes.La Société se réserve la possibilité de modifier ses prix à tout moment pour l’avenir. Les frais de télécommunication nécessaires à l’accès aux sites Internet de la Société sont à la charge du Client. Le cas échéant également, les frais de livraison.</p>
			...
			<div class="cgv-left"><h2>Article 2 : Prix</h2><br />
Les prix des produits vendus au travers des sites Internet sont indiqués en Euros hors taxes et précisément déterminés sur les pages de descriptifs des Produits. Ils sont également indiqués en euros toutes taxes comprises (TVA + autres taxes éventuelles) sur la page de commande des produits, et hors frais spécifiques d'expédition. Pour tous les produits expédiés hors Union européenne et/ou DOM-TOM, le prix est calculé hors taxes automatiquement sur la facture. Des droits de douane ou autres taxes locales ou droits d'importation ou taxes d'état sont susceptibles d'être exigibles dans certains cas. Ces droits et sommes ne relèvent pas du ressort du Vendeur. Ils seront à la charge de l'acheteur et relèvent de sa responsabilité (déclarations, paiement aux autorités compétentes, etc.). Le Vendeur invite à ce titre l'acheteur à se renseigner sur ces aspects auprès des autorités locales correspondantes.La Société se réserve la possibilité de modifier ses prix à tout moment pour l’avenir. Les frais de télécommunication nécessaires à l’accès aux sites Internet de la Société sont à la charge du Client. Le cas échéant également, les frais de livraison.</div>
			
			<div class="cgv-left"><span style="color: #ff0000;"><h2>Article 2.1 : Prix - exemple de clause illicite</h2></span><br />
<span style="color: #ff0000;"> La Société se réserve la possibilité de changer les prix à tout moment des produits achetés sur abonnements par le consommateur.</span></div>
			
			<div class="cgv-left"><h2>Article 3 : Conclusion du contrat en ligne</h2><br />
...
Le Vendeur se réserve la possibilité de refuser la commande, par exemple pour toute demande anormale, réalisée de mauvaise foi ou pour tout motif légitime.</div>
			
			
			<div class="cgv-left"><h2>Article 4 : Produits et services</h2><br />
Les caractéristiques essentielles des biens, des services et leurs prix respectifs sont mis à disposition de l’acheteur sur les sites Internet de la société. Le client atteste avoir reçu un détail des frais de livraison ainsi que les modalités de paiement, de livraison et d’exécution du contrat. Le Vendeur s’engage à honorer la commande du Client dans la limite des stocks de Produits disponibles uniquement. A défaut, le Vendeur en informe le Client. Ces informations contractuelles sont présentées en détail et en langue française. Conformément à la loi française, elles font l’objet d’un récapitulatif et d’une confirmation lors de la validation de la commande. Les parties conviennent que les illustrations ou photos des produits offerts à la vente n’ont pas de valeur contractuelle. La durée de validité de l’offre des Produits ainsi que leurs prix est précisée sur les sites Internet de la Société, ainsi que la durée minimale des contrats proposés lorsque ceux-ci portent sur une fourniture continue ou périodique de produits ou services. Sauf conditions particulières, les droits concédés au titre des présentes le sont uniquement à la personne physique signataire de la commande (ou la personne titulaire de l’adresse email communiqué).Conformément aux dispositions légales en matière de conformité et de vices cachés, le Vendeur rembourse ou échange les produits défectueux ou ne correspondant pas à la commande. Le remboursement peut être demandé de la manière suivante : ________ (décrire la procédure de remboursement, et comment le produit doit être retourné, et le remboursement des frais d'expédition le cas échéant).</div>
			...
			<div class="cgv-left"><h2>Article 5 : Clause de réserve de propriété</h2><br />
Les produits demeurent la propriété de la Société jusqu’au complet paiement du prix.</div>
			
			<div class="cgv-left">
<p><h2>Article 6 : Modalités de livraison</h2></p>
<p>Les produits sont livrés à l'adresse de livraison qui a été indiquée lors de la commande et le délai indiqué. Ce délai ne prend pas en compte le délai de préparation de la commande.<br />
...
<div class="cgv-left"><h2>Article 9 : Délai de rétractation</h2><br />
...
Procédure de remboursement : _____ (décrire précisément la procédure de remboursement - en particulier pour les gros achats)</div>

<div class="cgv-left">
<p><h2>Article 10 : Garanties</h2></p>
<p>Conformément à la loi, le Vendeur assume deux garanties : de conformité et relative aux vices cachés des produits. Le Vendeur rembourse l'acheteur ou échange les produits apparemment défectueux ou ne correspondant pas à la commande effectuée.<br />
La demande de remboursement doit s'effectuer de la manière suivante : _________ (détailler la procédure)</p>
...
<p>Garanties complémentaires : _____ (décrire vos garanties complémentaires)</p>
</div>

<div class="cgv-left"><h2>Article 11 : Réclamations</h2><br />
Le cas échéant, l’Acheteur peut présenter toute réclamation en contactant la société au moyen des coordonnées suivantes _____ (indiquer les coordonnées et la procédure).</div>

<div class="cgv-left"><h2>Article 12 : Droits de propriété intellectuelle</h2><br />
...
<div class="cgv-left"><h2>Article 13 : Force majeure</h2><br />
...
<div class="cgv-left"><h2>Article 14 : nullité et modification du contrat</h2><br />
Si l’une des stipulations du présent contrat était annulée, cette nullité n’entraînerait pas la nullité des autres stipulations qui demeureront en vigueur entre les parties. Toute modification contractuelle n’est valable qu’après un accord écrit et signé des parties.</div>

<div class="cgv-left"><h2>Article 15 : Protection des données personnelles</h2><br />
Conformément à la Loi Informatique et Libertés du 6 janvier 1978, vous disposez des droits d’interrogation, d’accès, de modification, d’opposition et de rectification sur les données personnelles vous concernant. En adhérant à ces conditions générales de vente, vous consentez à ce que nous collections et utilisions ces données pour la réalisation du présent contrat. En saisissant votre adresse email sur l’un des sites de notre réseau, vous recevrez des emails contenant des informations et des offres promotionnelles concernant des produits édités par la Société et de ses partenaires. Vous pouvez vous désinscrire à tout instant. Il vous suffit pour cela de cliquer sur le lien présent à la fin de nos emails ou de contacter le responsable du traitement (la Société) par lettre RAR. Nous effectuons sur l’ensemble de nos sites un suivi de la fréquentation. Pour cela, nous avons recours à des outils tels que ________________.</div>

<div class="cgv-left"><h2>Article 16 Clause limitative de responsabilité</h2><br />
Il est stipulé une clause limitative de responsabilité du Vendeur pour la réalisation de la prestation à _____________ euros.</div>
